...
def preprocess(df):
    float_cols = ["lat", "lng"]
    int_cols = ["population", "population_proper"]
...
with DAG(
    ...
    description="DAG for External Sourced Indonesia Cities Latitude & Longitude ETL",
    ...
    ext_lat_long_city_id = PostgreCSVOperator(
