...
config = {
    "script_name": "mart_op_voucher_cc_check",
...
with DAG(
    ...
    description="DAG for Order Payment Voucher Credit Card Check Mart Migration",
    ...
    mart_op_voucher_cc_check = PostgreSQLOperator(
        task_id="mart_op_voucher_cc_check",
    ...
    start >> mart_op_voucher_cc_check >> finish