...
config = {
    "script_name": "mart_customer_by_state",
...
with DAG(
    ...
    description="DAG for Customer by State Mart Migration",
    ...
    mart_customer_by_state = PostgreSQLOperator(
        task_id="mart_customer_by_state",
    ...
    start >> mart_customer_by_state >> finish