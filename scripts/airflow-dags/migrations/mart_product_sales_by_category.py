...
config = {
    "script_name": "mart_product_sales_by_category",
...
with DAG(
    ...
    description="DAG for Product Sales by Category Mart Migration",
    ...
    mart_product_sales_by_category = PostgreSQLOperator(
        task_id="mart_product_sales_by_category",
    ...
    start >> mart_product_sales_by_category >> finish