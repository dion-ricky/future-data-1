...
config = {
    "script_name": "mart_shipping_cost_by_state",
...
with DAG(
    ...
    description="DAG for Shipping Cost by State Mart Migration",
    ...
    mart_shipping_cost_by_state = PostgreSQLOperator(
        task_id="mart_shipping_cost_by_state",
    ...
    start >> mart_shipping_cost_by_state >> finish