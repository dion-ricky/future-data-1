...
config = {
    "script_name": "mart_customer_loyalty",
...
with DAG(
    ...
    description="DAG for Customer Loyalty Mart Migration",
    ...
    mart_customer_loyalty = PostgreSQLOperator(
        task_id="mart_customer_loyalty",
    ...
    start >> mart_customer_loyalty >> finish