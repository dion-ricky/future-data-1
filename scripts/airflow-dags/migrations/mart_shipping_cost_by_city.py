...
config = {
    "script_name": "mart_shipping_cost_by_city",
...
with DAG(
    ...
    description="DAG for Shipping Cost by City Mart Migration",
    ...
    mart_shipping_cost_by_city = PostgreSQLOperator(
        task_id="mart_shipping_cost_by_city",
    ...
    start >> mart_shipping_cost_by_city >> finish