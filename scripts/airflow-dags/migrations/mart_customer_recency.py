...
config = {
    "script_name": "mart_customer_recency",
...
with DAG(
    ...
    description="DAG for Customer Recency Mart Migration",
    ...
    mart_customer_recency = PostgreSQLOperator(
        task_id="mart_customer_recency",
    ...
    start >> mart_customer_recency >> finish