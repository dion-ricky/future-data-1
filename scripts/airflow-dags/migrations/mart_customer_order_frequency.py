...
with DAG(
    ...
    description="DAG for Customer Order Frequency Mart Migration",
    ...
    mart_customer_order_frequency = PostgreSQLOperator(
        task_id="mart_customer_order_frequency",
    ...
    start >> mart_customer_order_frequency >> finish