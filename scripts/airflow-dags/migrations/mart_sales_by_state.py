...
config = {
    "script_name": "mart_sales_by_state",
...
with DAG(
    ...
    description="DAG for Sales by State Mart Migration",
    ...
    mart_sales_by_state = PostgreSQLOperator(
        task_id="mart_sales_by_state",
    ...
    start >> mart_sales_by_state >> finish