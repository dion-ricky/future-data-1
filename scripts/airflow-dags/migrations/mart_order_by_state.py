...
config = {
    "script_name": "mart_order_by_state",
...
with DAG(
    ...
    description="DAG for Order by State Mart Migration",
    ...
    mart_order_by_state = PostgreSQLOperator(
        task_id="mart_order_by_state",
    ...
    start >> mart_order_by_state >> finish