...
config = {
    "script_name": "fact_order_feedback",
...
with DAG(
    ...
    description="DAG for Order Feedback Fact Migration",
    ...
    fact_order_feedback = PostgreSQLOperator(
        task_id="fact_order_feedback",
    ...
    start >> fact_order_feedback >> finish