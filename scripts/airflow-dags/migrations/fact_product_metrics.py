...
config = {
    "script_name": "fact_product_metrics",
...
with DAG(
    ...
    description="DAG for Product Metrics Fact Migration",
    ...
    fact_product_metrics = PostgreSQLOperator(
        task_id="fact_product_metrics",
    ...
    start >> fact_product_metrics >> finish