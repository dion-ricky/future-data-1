...
config = {
    "script_name": "mart_transaction_value",
...
with DAG(
    ...
    description="DAG for Transaction Value Migration",
    ...
    mart_transaction_value = PostgreSQLOperator(
        task_id="mart_transaction_value",
    ...
    start >> mart_transaction_value >> finish