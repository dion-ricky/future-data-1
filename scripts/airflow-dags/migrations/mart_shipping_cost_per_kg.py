...
config = {
    "script_name": "mart_shipping_cost_per_kg",
...
with DAG(
    ...
    description="DAG for Shipping Cost per Kg Mart Migration",
    ...
    mart_shipping_cost_per_kg = PostgreSQLOperator(
        task_id="mart_shipping_cost_per_kg",
    ...
    start >> mart_shipping_cost_per_kg >> finish